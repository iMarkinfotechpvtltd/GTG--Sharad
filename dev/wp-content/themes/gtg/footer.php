            ...
            <div class="newsletter-inner">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <p><?php echo get_option_tree('newsletter_description');?></p>
                    </div>
    ...
    <footer>
        <div class="container">
            <div class="menu1">
                ...
                <p><?php echo get_option_tree('social_media_description');?></p>
            </div>
            <div class="menu2">
            ...
            <div class="menu3">
                ...
                <p class="address"><?php echo get_option_tree('contact_address');?></p>
                <p class="phone">
                ...
                <a href="mailto:<?php echo get_option_tree('contact_email');?>" class="f-email"><?php echo get_option_tree('contact_email');?>
				</a>
            </div>
            <div class="menu4">
                <figure>
...
jQuery('.cls_submit_btn').click(function(){
   ...
   setTimeout(function(){ jQuery('.alert-success').fadeOut('slow'); }, 9000);
   setTimeout(function(){ jQuery('.alert-danger').fadeOut('slow'); }, 9000);
});
</script>
...
window.setTimeout(function() { jQuery(".alert-success").alert('close'); }, 13000);

jQuery(".alert-danger").alert();
window.setTimeout(function() { jQuery(".alert-danger").alert('close'); }, 13000);
});
</script>
...
jQuery('.wpcf7-submit').click(function(){
   ...
   setTimeout(function(){ jQuery('.wpcf7-validation-errors').fadeOut('slow'); }, 10000);
   setTimeout(function(){ jQuery('.wpcf7-mail-sent-ok').fadeOut('slow'); }, 10000);
   
   setTimeout(function(){ jQuery("input[name='Itemno']").val(''); }, 2000);
   setTimeout(function(){ jQuery("input[name='ItemLength']").val(''); }, 2000);
   setTimeout(function(){ jQuery("input[name='ItemAvilState']").val(''); }, 2000);
   setTimeout(function(){ jQuery("input[name='Itemcolor']").val(''); }, 2000);
   setTimeout(function(){ jQuery("input[name='Itemdesc']").val(''); }, 2000);
});
</script>
