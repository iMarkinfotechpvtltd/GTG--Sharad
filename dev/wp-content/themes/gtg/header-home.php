            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-caption">
                        <div class="container">
                            <figure>
							<!--GETTING HOME BANNER FROM OPTION TREE -->	
								<img src="<?php echo get_option_tree('home_banner_logo');?>" alt="banner_logo"/>
							</figure>
							<?php echo get_option_tree('home_banner_description');?> 
                        </div>
                    </div>
					...
					while( $banner_slider -> have_posts() ) : $banner_slider -> the_post();
					?>
					 <div class="item <?php if($i==0) { echo 'active';}?>">
					 <?php
					  $src = wp_get_attachment_image_src( get_post_thumbnail_id($banner_slider->ID),'home_banner_size' ); 
					   ?>  					 
