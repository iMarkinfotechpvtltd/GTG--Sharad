    ...
    <section class="blog">
        <div class="container">
            ...
            <div class="blog-white">
                <div class="row">
                    <div class="col-sm-8 col-xs-12 blog-left more_post">
                        <ul>
                            <?php 
                    ...
                    <div class="col-sm-4 col-xs-12 blog-right">
                        <div class="blog-sidebar">
                            <div class="search-box">
                                ...
                                <form role="search" method="get" id="searchform" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                    ...
                                    <input type="text" placeholder="SEARCH BLOG" name="s" id="s" value="<?php echo get_search_query(); ?>">
